                ...
                <div class="max-w-7xl mx-auto pt-16 pb-12 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <p class="text-gray-400 mb-8 leading-relaxed max-w-sm text-lg">
                                Your all-in-one platform for powerful development tools and utilities. Build faster, work smarter, and achieve more.
                            </p>
                            <!-- Social Links -->
                            <div class="flex space-x-5">
                                ...
                                <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-gray-700 hover:text-white transition-all transform hover:-translate-y-1">
                    ...
                    <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div class="flex items-center space-x-2 text-sm text-gray-500 font-medium">
                            ...
                            <span>&copy; {{ date('Y') }} {{ config('app.name', 'CIP Tools') }}. All rights reserved.</span>
                        </div>
                    </div>
                </div>

                <!-- Animated Accent Line (Last element, no margin below) -->
